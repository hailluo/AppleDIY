 ...
 *
 * Disassembly of iASL25CZRO.aml, Tue May 22 18:12:34 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000E635 (58933)
 *     Revision         0x02
 *     Checksum         0xC6
 *     OEM ID           "ACRSYS"
...
DefinitionBlock ("", "DSDT", 2, "ACRSYS", "ACRPRDCT", 0x00000000)
{
    ...
    External (_SB_.PCI0.IGPU.OBV_, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.WKAR, MethodObj)    // 0 Arguments (from opcode)
    ...
    Name (DPPL, 0x8000)
    OperationRegion (GNVS, SystemMemory, 0x9AFBBA98, 0x0307)
    ...
    OperationRegion (OGNS, SystemMemory, 0x9AFBA018, 0x098E)
